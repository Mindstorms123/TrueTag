    ...
    chrome.runtime.sendMessage(
      {
        ...
        productInfo: {
          model_number: productInfo.modelNumber || productInfo.model_number || null,
          asin: productInfo.asin || productInfo.asin || null,
          product_title: productInfo.title || productInfo.productTitle || null,
          amazon_url: productInfo.amazonUrl || productInfo.amazon_url || null,
          store: productInfo.store || null,
          offer_url: currentUrl,
          source_url: currentUrl,
          source_type: productPage ? 'product' : 'search',
          offer_type: productPage ? 'product' : 'search',
